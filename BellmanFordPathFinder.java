 ...
 * Develpor Notes:
    ...
    * Dont actually know if baritone gives us negative edges but this is just in case
    * Use a hashmap for that to check how many times
 * 
 * Steps to implement Bellman Ford
 * make queue
 * insert start node at queue
 * for the node in the start of the queue, relax the cost of every neighbor
